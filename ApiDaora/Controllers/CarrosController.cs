...
namespace ApiDaora.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarrosController : ControllerBase
    {
        private readonly DBcbrContext _context;

        public CarrosController(DBcbrContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Carros>> PostCarros(Carros carros)
        {
          if (_context.Carros == null)
          {
              return Problem("Entity set 'DBcbrContext.Carros'  is null.");
          }
